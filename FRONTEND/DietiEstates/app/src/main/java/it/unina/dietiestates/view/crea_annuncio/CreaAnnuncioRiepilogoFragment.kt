...
class CreaAnnuncioRiepilogoFragment : Fragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.tipoAnnuncioTextView).text = annuncioVM.tipoAnnuncio.toString()
        view.findViewById<TextView>(R.id.dimensioniTextView).text = annuncioVM.dimensioni.toString()
        view.findViewById<TextView>(R.id.prezzoTextView).text = annuncioVM.prezzo.toString()
        ...
        val boxAuto = view.findViewById<TextView>(R.id.boxAutoTag)
